...
This script is an example (work in process!) of how to convert the localizer data to BIDS format. 
It takes the raw data and sets up a BIDS structure in a specified 
repository (bids_root).

Have a look at the documentation here: https://mne.tools/mne-bids/index.html

It can also anonymize the MEG data. 
...
# define event ids to be saved as annotation
# look into the config file for comments if you don't know how to set them
stim_channel = 'STI101'
